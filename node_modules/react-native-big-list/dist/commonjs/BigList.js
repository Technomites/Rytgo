...
var _BigListPlaceholder = _interopRequireDefault(require("./BigListPlaceholder"));
...
class BigList extends _react.PureComponent {
  ...
  constructor(props) {
    super(props);
    (0, _utils.autobind)(this);
    // Initialize properties and state
    this.containerHeight = 0;
    this.scrollTop = 0;
    this.scrollTopValue = this.props.initialScrollIndex || new _reactNative.Animated.Value(0);
   ...
   */
  static getListState(_ref, _ref2) {
    let {
      data,
      sections,
      batchSizeThreshold,
  ...
  getListState(props, options) {
    ...
    return this.constructor.getListState(stateProps, options || (0, _utils.processBlock)({
   ...
   * @returns {int[]}
   */
  static getSectionLengths() {
    let sections = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  onViewableItemsChanged() {
    ...
    if (onViewableItemsChanged) {
      ...
      const currentItems = this.state.items.map(_ref9 => {
        let {
          type,
          section,
          index,
      ...
      const changed = prevItems.filter(_ref10 => {
        let {
          index: prevIndex
        } = _ref10;
        return !this.viewableItems.some(_ref11 => {
          let {
            index: nextIndex
          } = _ref11;
  ...
  renderItems() {
    ...
    const emptyItem = ListEmptyComponent ? (0, _utils.createElement)(ListEmptyComponent, {
      style: fullItemStyle
    }) : renderEmpty ? (0, _utils.createElement)(renderEmpty(), {
      style: fullItemStyle
    }) : null;
    if (isEmptyList && emptyItem) {
      if (hideMarginalsOnEmpty || hideHeaderOnEmpty && hideFooterOnEmpty) {
        ...
        // Add empty item
        const headerIndex = items.findIndex(item => item.type === _BigListItem.BigListItemType.HEADER);
        ...
        if (hideFooterOnEmpty) {
          // Hide footer
          const footerIndex = items.findIndex(item => item.type === _BigListItem.BigListItemType.FOOTER);
      ...
      switch (type) {
        case _BigListItem.BigListItemType.HEADER:
          if (ListHeaderComponent != null) {
            ...
            style = (0, _utils.mergeViewStyle)(fullItemStyle, ListHeaderComponentStyle);
          } else {
            child = renderHeader();
            style = fullItemStyle;
          }
        ...
        case _BigListItem.BigListItemType.FOOTER:
          if (type === _BigListItem.BigListItemType.FOOTER) {
            if (ListFooterComponent != null) {
              ...
              style = (0, _utils.mergeViewStyle)(fullItemStyle, ListFooterComponentStyle);
            } else {
              child = renderFooter();
              style = fullItemStyle;
            }
        ...
        case _BigListItem.BigListItemType.ITEM:
          if (type === _BigListItem.BigListItemType.ITEM) {
            ...
            style = numColumns > 1 ? (0, _utils.mergeViewStyle)(itemStyle, columnWrapperStyle || {}) : itemStyle;
          ...
          if (child != null) {
            children.push(type === _BigListItem.BigListItemType.ITEM && controlItemRender ? child : /*#__PURE__*/_react.default.createElement(_BigListItem.default, {
              key: itemKey,
              uniqueKey: uniqueKey,
              height: height,
              width: 100 / numColumns + "%",
        ...
        case _BigListItem.BigListItemType.EMPTY:
          children.push( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
            key: itemKey
          }, emptyItem));
          break;
  ...
  render() {
    ...
    const handleScroll = stickySectionHeadersEnabled && _reactNative.Platform.OS === "web" ? _reactNative.Animated.event([{
      nativeEvent: {
        contentOffset: {
          y: this.scrollTopValue
        }
    ...
    const defaultProps = {
      refreshControl: onRefresh && !this.props.refreshControl ? /*#__PURE__*/_react.default.createElement(_reactNative.RefreshControl, {
    ...
    scrollViewProps.contentContainerStyle = (0, _utils.mergeViewStyle)(props.contentContainerStyle, defaultProps.contentContainerStyle);
    const ListScrollView = ScrollViewComponent || _reactNative.Animated.ScrollView;
    const scrollView = wrapper( /*#__PURE__*/_react.default.createElement(ListScrollView, scrollViewProps, this.renderItems()));
...
BigList.defaultProps = {
  ...
  ScrollViewComponent: _reactNative.Animated.ScrollView
};
