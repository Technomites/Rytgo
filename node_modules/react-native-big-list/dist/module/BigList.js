...
class BigList extends PureComponent {
  ...
  constructor(props) {
    ...
    this.scrollTop = 0;
    this.scrollTopValue = this.props.initialScrollIndex || new Animated.Value(0);
  ...
  getItemOffset(_ref12) {
    ...
    // Header + inset
    let offset = insetTop + isNumeric(headerHeight) ? Number(headerHeight) : headerHeight();
  ...
  renderItems() {
    ...
    const emptyItem = ListEmptyComponent ? createElement(ListEmptyComponent, {
      style: fullItemStyle
    ...
    if (isEmptyList && emptyItem) {
      if (hideMarginalsOnEmpty || hideHeaderOnEmpty && hideFooterOnEmpty) {
        ...
        // Add empty item
        const headerIndex = items.findIndex(item => item.type === BigListItemType.HEADER);
        ...
        if (hideFooterOnEmpty) {
          // Hide footer
          const footerIndex = items.findIndex(item => item.type === BigListItemType.FOOTER);
    ...
    items.forEach(_ref15 => {
      ...
      switch (type) {
        ...
        case BigListItemType.ITEM:
          ...
          if (child != null) {
            children.push(type === BigListItemType.ITEM && controlItemRender ? child : /*#__PURE__*/React.createElement(BigListItem, {
              key: itemKey,
              uniqueKey: uniqueKey,
              height: height,
              width: 100 / numColumns + "%",
        ...
        case BigListItemType.SPACER:
          children.push(placeholder ? /*#__PURE__*/React.createElement(BigListPlaceholder, {
            key: itemKey,
            height: height,
        ...
        case BigListItemType.SECTION_HEADER:
          ...
          if (child != null) {
            children.push( /*#__PURE__*/React.createElement(BigListSection, {
              key: itemKey,
              style: fullItemStyle,
              height: height,
              position: position,
  ...
  render() {
    ...
    const handleScroll = stickySectionHeadersEnabled && Platform.OS === "web" ? Animated.event([{
      nativeEvent: {
        contentOffset: {
          y: this.scrollTopValue
        }
    ...
    const defaultProps = {
      refreshControl: onRefresh && !this.props.refreshControl ? /*#__PURE__*/React.createElement(RefreshControl, {
    ...
    const scrollView = wrapper( /*#__PURE__*/React.createElement(ListScrollView, scrollViewProps, this.renderItems()));
