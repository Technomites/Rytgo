 ...
 */
export const processBlock = _ref => {
  let {
    containerHeight,
    scrollTop,
 ...
 * @returns {Object}
 */
export const mergeViewStyle = function (style) {
...
export const createElement = function (Component) {
  ...
  return Component != null ? /*#__PURE__*/React.isValidElement(Component) ? /*#__PURE__*/React.cloneElement(Component, props) : /*#__PURE__*/React.createElement(Component, props) : null;
};
