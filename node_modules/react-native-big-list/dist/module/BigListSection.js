...
const BigListSection = _ref => {
  ...
  const fillChildren = /*#__PURE__*/React.isValidElement(child) && /*#__PURE__*/React.cloneElement(child, mergeViewStyle(style, {
    style: {
      flex: 1
    }
  }));
  const viewStyle = [{
    elevation: 10
  }, /*#__PURE__*/React.isValidElement(child) && child.props.style ? child.props.style : style, {
    zIndex: 10,
    height: height,
    width: "100%",
    transform: [{
